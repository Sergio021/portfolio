        ...
        allProjects = [ 
            {
                ...
                "category": "landing",
                "year": 2021,
                "description": "Esta fue una de las landings que realice en Mapalab, se uso para promocionar del album K.O de Danna Paola.\n Para poder iniciar sesión era requerida una cuenta de Spotify, ya que el objetivo era realizar \"presave\"del album completo. Al iniciar sesión, podias desplazarte entre las fotos exclusivas de Danna Paola referentes a su nuevo albúm. Para esta landing me encargue del diseño UX, maquetación, implementación de funcionalidades y programación de la parte backend.",
            ...
            },
            {
                ...
                "category": "web",
                "year": 2021,
                "description": "Dämadi Sweethomes es un sitio web dedicado a brindar información acerca del asilo para adultos mayores. El sitio ofrece detalles sobre las instalaciones, servicios, actividades, enfermeria, cuidados especializados y opciones de alojamiento para los abuelos. Mi trabajo se centro en la creación del sitio web, maquetación del diseño usando Wordpress, HTML, CSS y PHP, además del mantenimiento y la gestión del contenido.",
                "tech": "WordPress, HTML, PHP, CSS",
            ...
            },
            {
                ...
                "category": "web managment",
                "year": 2025,
                "description": "Thyroid aware es el sitio multilenguaje de \"Mide tu tiroides\". Mi trabajo en este proyecto se centró en el mantenimiento del sitio, maquetación de nuevas secciones, gestion de contenido y a incoporación de nuevas funcionalidades a traves de pugins personalizados.",
                "tech": "WordPress, PHP, JavaScript, HTML, CSS",
                "url": "https://midetutiroides.endocrinologia.org.mx/",
                "deprecated": false
            },
            ...
            },
            {
                ...
                "category": "web managment",
                "year": 2025,
                "description": "Para el sitio de nivea, mi labor se centró en la gestión de contenido y la creación de secciones a traves del CMS sitecore, el cual permite la gestión de multisitios y multilenguaje.",
...
function verDetalle(id) {
    console.log('Ver detalle del proyecto con ID:', id);
